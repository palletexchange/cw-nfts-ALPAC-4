...
use cw721::query::query_creator_ownership;
use cw721::Approval;
    ...
    TQueryExtensionMsg: Serialize + DeserializeOwned + Clone,
{
    fn query(
        ...
        match msg {
            Cw1155QueryMsg::Minter {} => to_json_binary(&query_creator_ownership(deps.storage)?),
            ...
            Cw1155QueryMsg::OwnersOf {
                ...
                let config = Cw1155Config::<
                    ...
                    TQueryExtensionMsg,
                >::default();
                let start_after = start_after.map(|address| {
                    Bound::exclusive((Addr::unchecked(address), token_id.to_string()))
                });
                let balances = config
                    .balances
                    .idx
            ...
            Cw1155QueryMsg::ContractInfo {} => to_json_binary(
                &Cw1155Config::<
                    TMetadataExtension,
                    TCustomResponseMessage,
                    TMetadataExtensionMsg,
